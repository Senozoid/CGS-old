...
nohup ./a.out "./Dataset/$1" "./Compressed/$2" "./Compressed/$3" "$4" "./SP_Results/$1" > sp.log 2>&1 &

echo "Code running in the backgroud. Results will be saved in the 'SP_Results' folder."